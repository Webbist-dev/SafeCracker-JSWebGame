...
let clickLoc = {//For storing/checking mouse click locations
	x: undefined,
	y: undefined
}
let scale = {//Store screen scale factor for mouse click on canvas vs window scale
	x: undefined,
	y: undefined
}
...
window.addEventListener('mousedown', 
	function(event) {//anonymous fucntion with event argument
